...
CREATE TABLE IF NOT EXISTS `promo_code` (
  ...
  `name` varchar(255) DEFAULT NOT NULL COMMENT 'Promo Name',
  ...
  `startDate` int(10) unsigned NOT NULL COMMENT 'Promo Start Date',
  `endDate` int(10) unsigned NOT NULL COMMENT 'Promo End Date',
  `banner` varchar(255) DEFAULT NULL COMMENT 'Promo Banner',
  `rules` ENUM('otg', 'sp', 'pw') NOT NULL COMMENT 'Promo Rules e.g Order Total is Greater than, Spesifict Product, Payment With',
  `amount` decimal(13, 2) NULL COMMENT 'Promo Amount Rules OTG(Order Total is Greater than)',
  `productSlug` varchar(255) DEFAULT NULL COMMENT 'Promo Product Slug Rules SP(Spesifict Product)',
  ...
  `discounAmount` decimal(13, 2) NULL COMMENT 'Discount Amount e.g Value Fix Price, Value Percentage',
  ...
  `platform` varchar(50) DEFAULT NOT NULL COMMENT 'Platform name',
