...
type Config struct {
	...
	AppApiPath  string `envconfig:"APP_API_PATH" default:"/api/v1/payment"`
	...
	DBMySQLDbName            string `envconfig:"MYSQL_DBNAME" default:"payment"`
	...
	PlatformConfig string `envconfig:"PROMO_CREDENTIAL" default:""`
}
